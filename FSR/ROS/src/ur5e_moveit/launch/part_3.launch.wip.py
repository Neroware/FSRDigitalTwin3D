...
def launch_setup(context):
    ...
    controller_spawner_node = Node(
        ...
        arguments="joint_state_controller ur5e_follow_joint_trajectory_controller --shutdown-timeout 1"
    )

    return [server_endpoint_node, mover_node, controller_spawner_node]
